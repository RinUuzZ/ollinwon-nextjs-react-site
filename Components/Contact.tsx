          ...
          <div>
            ...
            <form method="POST" onSubmit={handleSubmit} enctype="application/x-www-form-urlencoded" >
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <input
                  type="text" name="fullname" required="required"  onChange={handleChange} 
                  placeholder="Full Name"
                  className="py-3 px-4 rounded-md bg-gray-800 text-white outline-none"
                />
                <input
                   type="text" name="email" required="required"  onChange={handleChange} 
                  placeholder="Email Address"
                  className="py-3 px-4 rounded-md bg-gray-800 text-white outline-none"
                />
              </div>
              <input
                 type="text" name="mobilenumber" required="required"  onChange={handleChange}
                placeholder="Mobile Number"
                className="py-3 px-4 rounded-md bg-gray-800 text-white outline-none mt-4"
              />
              <textarea
                 required="required" onChange={handleChange}  name="message" 
                placeholder="Message"
